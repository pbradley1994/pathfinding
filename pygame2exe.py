...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Graph.py"
 
        #Name of program
        self.project_name = "Pathfinding"
 
        #Project url
        self.project_url = "https://github.com/rainlash/pathfinding"
        ...
        #Description
        self.project_description = "Interactive Pathfinding"
